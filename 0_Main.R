...
p1
ggsave("Outputs/Figures/SpeciesMaps_group1.jpeg", width = 6, height = 4, dpi = "retina")

p2
ggsave("Outputs/Figures/SpeciesMaps_group2.jpeg", width = 6, height = 6, dpi = "retina")

p3
ggsave("Outputs/Figures/SpeciesMaps_group3.jpeg", width = 6, height = 8, dpi = "retina")

lc_map
ggsave("Outputs/Figures/MA_lc_map.jpeg", width = 5, height = 5, dpi = "retina")

p_map
ggsave("Outputs/Figures/SpeciesMaps_contrast.jpeg", width = 6, height = 4, dpi = "retina")

g4 <- (p4 / p5 / p6) 
ggsave("Outputs/Figures/SpeciesTS_groups.jpeg", width = 6, height = 6.5, dpi = "retina")

p7
ggsave("Outputs/Figures/PC1_PC2_loadings.jpeg", width = 6, height = 6, dpi = "retina")
